          ...
          (t.exports = function(t, n, e, f) {
            ...
            _
              ...
              : L(function(t) {
                ...
                q(m !== Function.prototype ? k(y).concat(k(m)) : k(y), function(
                  t
                ) {
                  t in g || h(g, t, y[t]);
                }),
    ...
    function(t, n, e) {
      ...
      var r = e(18),
        ...
        o = (function() {
          ...
          return (
            (t.prototype.createButtonElement = function(id) {
              if (!0 === this.use) {
                for (
        ...
        m = (function() {
          function t(n) {
            (0, o['default'])(this, t),
              ...
              (this.naverButtonId = n.naverButtonId),
          ...
          return (
            ...
            (t.prototype.setLoginButton = function() {
              var t = this.loginButtonHandler.createButtonElement(this.naverButtonId);
              null != t &&
                document.getElementById(this.naverButtonId).appendChild(t);
            }),
            ...
            (t.prototype.popup = function() {
              ...
              new c['default'](
                ...
                'naver_login',
                null
              ).attachOnclickEvent(this.naverButtonId + '_wrapper');
            }),
            (t.prototype.attachLoginButtonEvent = function() {
              var t = this,
                n = document.getElementById(this.naverButtonId+'_loginButton');
              null != n &&
